                            ...
                            <div class="container ftco-animate">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-4 aos-init aos-animate" data-aos="fade-up">
                                        <a href="<?=ROOT_URL?>/giao-vien" class="room">
                                            <figure class="img-wrap m-0">
                                                <img src="<?=PATH_URL?>/images/about-cat-1.jpg" alt="Cơ sở pháp lý 1" class="hover-scale img-fluid mb-3">
                                            </figure>
                                    ...
                                    <div class="col-md-6 col-lg-4 aos-init aos-animate" data-aos="fade-up">
                                        <a href="<?=ROOT_URL?>/giao-vien" class="room">
                                            <figure class="img-wrap m-0">
                                                <img src="<?=PATH_URL?>/images/about-cat-1.jpg" alt="" class="hover-scale img-fluid mb-3">
                                            </figure>
                                            <div class="p-3 padding-top-0 text-center">
                            ...
                            <div class="container ftco-animate">
                                <div class="row justify-content-center text-center mb-5 ftco-animate">
                                    ...
                                    <div class="row">
                                        ...
                                        <a href="<?=ROOT_URL?>/giao-vien" class="room">
                                            <figure class="img-wrap m-0">
                                                <img src="<?=PATH_URL?>/images/about-cat-1.jpg" alt="Cấu trúc" class="hover-scale img-fluid mb-3">
                                            </figure>
                                            <div class="text-center">
                                ...
                                <div class="slide">
                                    <div class="owl-carousel owl-theme" id="slide-about-page">
                                        <div class="slide-about-item">
                                            <a href=""><img src="<?=PATH_IMG_SITE?>/Bia-Tieng-Anh-1-SHS.png" alt="Cấu trúc" class="hover-scale img-fluid mb-3"></a>
                                        </div>
                            ...
                            <div class="container ftco-animate">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-12 col-lg-7 order-lg-2 aos-init" data-aos="fade-up">
                                        ...
                                        <p><a href="https://sachso.edu.vn/" class="btn btn-primary text-white py-2 mr-3 text-uppercase letter-spacing-1">Truy cập ngay</a></p>
                                    </div>
                                </div>
                            </div>
                        </section>
